...
del(nxg,a)
#genrating graph (didn't work, too much memory)
#g_nn = ig.Graph.Weighted_Adjacency(a.tolist(),mode="UNDIRECTED", attr = "weight", loops = FALSE)
#getting edgelist
