## finding marker peaks per class
...
save(markersPeaks, file = "PeakCom/markerpeaks_Class.RData")
#q()
#load("markerpeaks_Class.RData")
...
save(marker_peaks, file="PeakCom/markerpeaks_class_com.RData")
