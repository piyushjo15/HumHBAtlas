...
import crested
import pickle
## LSTM v1 is CNN+RNN hybrid model without JASPAR motif initialization
##load bed files
dataDir='/home/DeepHB/'
...
model_architecture = crested.tl.zoo.deeptopic_lstm(seq_len=500, 
                                                   num_classes=57,
                                                   filters=1024, 
                                                   first_kernel_size=30, ## size of biggest motif is 29, used in v2
                                                   max_pool_size=16,
                                                   max_pool_stride=8, 
                                                   dense_out=1024,
                                                   lstm_out=512, 
...
trainer = crested.tl.Crested(
    ...
    config=config,
    project_name="DeepHB",  
    run_name="LSTMv1_57MP", ## no motif initialization
    logger=None,  
    seed=145
)
...
with open('met_deephb_lstmv1_57MP.pkl', 'wb') as f:
