...
### PA -----------
sams <- c("I007_070","I007_107","I023_009","I027_024","I054_021")
GSEA <- list()
...
##save
lengths(GSEA)
save(GSEA, file="MijaDIPG_degs.RData")
...
save(terms_list,terms_df,file="MijaDIPG_Reac.RData")
...
save(aa,file="MijaDIPG_gprofiler.RData")
q()
