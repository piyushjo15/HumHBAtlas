## this script is for Word to vec comparing the GN network obtained from
## normal glial cells to glial cels in DMG tumors
...
os.chdir(proj_DIR)
print("Performing Word2Vec analysis for Mija DMG samples ")
...
walks_nor= run_node2vec(f"Normalv2/gene_network_nor_pr_{partx}.edg")
w2v_nor= train_w2v(walks_nor)

# Tumors
walks_tum_I027_024= run_node2vec("I027_024/gene_network_I027_024_pr.edg")
w2v_tum_I027_024= train_w2v(walks_tum_I027_024)

walks_tum_I007_107= run_node2vec("I007_107/gene_network_I007_107_pr.edg")
w2v_tum_I007_107= train_w2v(walks_tum_I007_107)

walks_tum_I007_070= run_node2vec("I007_070/gene_network_I007_070_pr.edg")
w2v_tum_I007_070= train_w2v(walks_tum_I007_070)

walks_tum_I054_021= run_node2vec("I054_021/gene_network_I054_021_pr.edg")
w2v_tum_I054_021 = train_w2v(walks_tum_I054_021)

walks_tum_I023_009= run_node2vec("I023_009/gene_network_I023_009_pr.edg")
w2v_tum_I023_009 = train_w2v(walks_tum_I023_009)
...
def get_cosines(reference_model, 
    ...
    reference_model.save(os.path.join(write_path_ref_model, f'OligoAstroMicroglia_pr_dmg_{partx}.model'))

    for name_, w2vmodel in zip(name_list, comparison_models):
        print(f'aligning to {name_}')
        reference = Word2Vec.load(os.path.join(write_path_ref_model, f'OligoAstroMicroglia_pr_dmg_{partx}.model'))
        ...
        np.savez(
          os.path.join(os.fspath(name_), f"embeddings_aligned_pr_{partx}.npz"),
        ...
        df.iloc[:1] = 1.0
    try:
        os.remove(os.path.join(write_path_ref_model, f'OligoAstroMicroglia_pr_dmg.model'))
...
df_similarity=get_cosines(
    w2v_nor,
    genes_nor,
    ["I027_024","I007_107","I007_070","I054_021","I023_009"],
    "OligoAstroMicroglia",
    out_path,
    w2v_tum_I027_024,
    w2v_tum_I007_107,
...
with open(f"DMG_cosines_pr_{partx}.pkl", "wb") as f:
