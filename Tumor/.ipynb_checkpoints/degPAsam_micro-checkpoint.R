...
load("PA_Micro_HVG.RData")
load(paste0(DIR_NOR,"Nor_Micro_HVG.RData"))
...
cl <- grep("Microglia",plot.data$ANN3)
pd_tum <- plot.data[cl,]
...
## normal
load(paste0(DIR_NOR,"plotdataHBRv2.RData"))

cl <- c("Immune:Microglia_EGR1", "Immune:Macrophage","Immune:Microglia_PLP1",
        "Immune:Microglia_ERC2")
...
save(res, file="degMicrovsTumMicro_glm_new.RData")
q()
