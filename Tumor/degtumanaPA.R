...
GSEA[["astro_up"]] <- as.character(astro_up$Var1)[astro_up$Freq>1]
GSEA[["astro_down"]] <- as.character(astro_down$Var1)[astro_down$Freq>1]
...
GSEA[["oligo_up"]] <- as.character(oligo_up$Var1)[oligo_up$Freq>1]
GSEA[["oligo_down"]] <- as.character(oligo_down$Var1)[oligo_down$Freq>1]
...
GSEA[["micro_up"]] <- as.character(micro_up$Var1)[micro_up$Freq>1]
GSEA[["micro_down"]] <- as.character(micro_down$Var1)[micro_down$Freq>1]

##save
lengths(GSEA)
save(GSEA, file="PA_degs.RData")
...
save(terms_list,terms_df,file="PA_Reac.RData")
...
save(aa,file="PA_gprofiler.RData")
q()
